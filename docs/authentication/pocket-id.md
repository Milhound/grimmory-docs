...
![Grimmory OIDC Settings](/img/authentication/pocket-id/grimmory-oidc-settings.jpg)
...
![Grimmory App Card](/img/authentication/pocket-id/app-card.jpg)
...
- **[Group Mapping](oidc-settings.md#group-mapping):** Map Pocket ID groups to Grimmory permissions and library access
...
Auto-provisioning is off by default. Either enable it in [OIDC Settings](oidc-settings.md#-user-provisioning), or create a Grimmory user with a username that exactly matches the Pocket ID username (case-sensitive).
