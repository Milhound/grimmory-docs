...
| Field | Description |
|-------|-------------|
| **KOReader API Path** | The API endpoint to configure on your KOReader device. Auto-generated from your Grimmory URL (e.g., `http://your-booklore-domain/api/koreader`). Read-only with a copy button. |
