...
2. Click the **Add New Font** button
   ...
   ![Custom Fonts Tab](/img/custom-fonts/font-library.jpg)

3. Click the upload area or drag and drop a font file

   ![Font Upload Dialog](/img/custom-fonts/upload-dialog.jpg)

4. After selecting a file, a preview and name input appear. Enter a display name (or keep the filename).

   ![Font Selected](/img/custom-fonts/file-preview.jpg)
...
![Font Collection](/img/custom-fonts/font-collection.jpg)
...
![Global Font Setting](/img/custom-fonts/global-setting.jpg)
...
![Per-Book Font Setting](/img/custom-fonts/per-book-setting.jpg)
