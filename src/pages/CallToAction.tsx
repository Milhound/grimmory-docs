      ...
      <div className="container">
        ...
        >
          ...
          <p className={styles.ctaSubtitle}>
            Join readers organizing their digital libraries with Grimmory. Open source,
            self-hosted, and completely yours.
          </p>
          <div className={styles.ctaButtons}>
            ...
            <Link className={`button button--lg ${styles.discordButton}`} to="https://discord.gg/vNsB8CTebs">
